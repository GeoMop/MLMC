...
class ProcConc:
    ...
    def set_environment_variables(self):
        ...
        if tail == 'storage' or tail == 'auto':
            ...
            self.sample_timeout = 60
            self.adding_samples_coef = 0.1
            self.flow123d = ["/home/martin/Documents/flow_package_test/publish/flow123d_3.1.0_linux_install/flow123d_3.1.0/bin/fterm.sh", "flow123d"]
            # self.flow123d = [
            #     "/home/martin/Documents/flow123d/bin/fterm", "flow123d"]
            #self.flow123d = ["/home/martin/Documents/flow123d_3.0.1/bin/fterm.sh", "flow123d"]
