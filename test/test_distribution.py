...
class DistributionDomainCase:
    ...
    def find_regularization_param(self, plot_res=True, noise_level=0.01, work_dir=None):
        np.random.seed(1234)
        #noise_level = 1e-2
    ...
    def plot_KL_div_inexact_reg(self):
        ...
        tol_density = 1e-5
        results = []
        n_moments = 5  # 25 is not enough for TwoGaussians
