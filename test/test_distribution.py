...
class DistributionDomainCase:
    ...
    def find_regularization_param(self, plot_res=True, noise_level=0.01):
        np.random.seed(1234)
        #noise_level = 1e-2
        ...
        #reg_params = np.geomspace(1e-10, 1e-4, num=30)  # two gaussians 2nd der
        ...
        reg_params = np.geomspace(1e-9, 1e-5, num=60)
        #reg_params = [0]
