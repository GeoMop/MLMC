...
if __name__ == "__main__":
    ...
    #machine_learning_model = ("SVRL3_log", run_GNN, False)
    ...
    machine_learning_model = ("SVR_mesh_L3_log", run_SVR, False)
    #machine_learning_model = ("GCN_mesh_L3_log", run_GNN, False)
    #
    machine_learning_model = ("mesh_moments", run_GNN, False)
    ...
    graph_creation_time = 159#0#159#66
