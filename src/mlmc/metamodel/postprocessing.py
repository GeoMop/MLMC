...
def compare_densities(estimator_1, estimator_2, ref_estimator, label_1="", label_2=""):
    ...
    kl_div = mlmc.tool.simple_distribution.KL_divergence(ref_distr_obj.density, distr_obj_1.density, ref_distr_obj.domain[0], ref_distr_obj.domain[1])
    ...
    kl_div = mlmc.tool.simple_distribution.KL_divergence(ref_distr_obj.density, distr_obj_2.density, ref_distr_obj.domain[0],
...
def process_mlmc(mlmc_file, sampling_info_path, targets, predictions, train_targets, val_targets, l_0_targets=None, l_0_predictions=None,
    ...
    if l_0_targets is not None and l_0_predictions is not None:
        ...
        ref_sample_storage = ref_storage()
